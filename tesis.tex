...
%                                   DATOS                                      %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Sistema de monitoreo a través de redes de sensores para sistemas de energía fotovoltaicas}
\author{Arteaga Lara Samuel \\Flores Tepatl Giselle \\Saldaña Aguilar Andrés Arnulfo} 
...
\degreedate{21 de Noviembre del 2019}            % Año de la fecha de la presentación %MODIFICAR ESTA FECHA___________________________________
...
\keywords{Sistema embebido, IoT, Sistema Fotovoltaico, Nodo Sensor, Red de sensores}            % Palabras clave para los metadatos del PDF %PREGUNTAR POR ESTAS PALABRAS CLAVE__________________________________
...
%\include{Declaracion/Declaracion}           % Comentar línea
...
\listoffigures              % Genera el índice de figuras, comentar línea si no se usa
...
%DESCOMENTAR CONFORME AVANCEMOS
