...
\paragraph{Trayectoria alternativa H} \label{SUB-M-CU5:TH}
	...
	\begin{enumerate}[label=H\arabic*.]
		\item {[Aplicación de usuario]} Asigna como valor de generación 0, actualiza la interfaz de usuario \hyperref[fig:monitoreo]{[IU1-Monitoreo En Tiempo real]} y genera la notificación \hyperref[fig:Alerta de Servidor]{[N3-Alerta de Servidor]}.
		\item {[Aplicación de usuario]} Regresa al final de \hyperref[SUB-M-CU5:TA]{[Trayectoria alternativa A]}
	\end{enumerate}
	Fin de la trayectoria alternativa.
