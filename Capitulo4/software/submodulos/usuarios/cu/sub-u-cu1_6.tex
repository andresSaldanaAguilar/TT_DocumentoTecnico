...
\paragraph{Trayectoria principal}
	...
	\begin{enumerate}
		...
		\item {[Aplicación de Usuario]} Envía el periodo de tiempo semanal y el identificador del nodo 1 como valores de petición por defecto. \hyperref[SUB-U-CU1.3:TB]{[Trayectoria alternativa B]} 
