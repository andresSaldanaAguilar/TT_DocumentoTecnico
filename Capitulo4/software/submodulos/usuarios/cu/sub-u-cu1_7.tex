...
\paragraph{Trayectoria principal} \label{SUB-U-CU1.4:TP}
	\begin{enumerate}
		\item {[Usuario administrador o Usuario cliente]} Inicia por primera vez la aplicación móvil, selecciona en el menú de la aplicación la opción de Configuraciones que se muestra en la pantalla \hyperref[fig:Barra de navegacion]{[IU5-Barra de Navegación]} \hyperref[SUB-U-CU1.4:TA]{[Trayectoria alternativa A]} %Hasta aquí me quedé
