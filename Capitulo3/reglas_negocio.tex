...
\item \label{RN9}
		\begin{description}
			...
			\item[Descripción] El almacenamiento en el servidor está limitado por la memoria externa que le es agregada, por lo que usaremos una herramienta que trabaja con una cantidad de datos fija, definida en el momento de crear la base de datos, y un puntero al elemento actual ocupando siempre un constante de almacenamiento.
		\end{description}
