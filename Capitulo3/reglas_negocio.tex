...
\item \label{RN12}
		\begin{description}
			...
			Tiempo real: el criterio comparar sera el valor de generación obtenido contra el valor de generación esperado por un panel solar, que es de 250 Watts, donde la proporción nos dira lo siguiente:
			80\% - 100\% Generación Óptima
			50\% - 79\% Generacion Intermedia
			0
		\end{description}
